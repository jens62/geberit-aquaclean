...
echo "       If you have the repo cloned:"
echo "         bash operation_support/setup-service.sh"
echo "       Otherwise, clone it first:"
echo "         git clone https://github.com/jens62/geberit-aquaclean.git"
echo "         bash geberit-aquaclean/operation_support/setup-service.sh"
echo ""
