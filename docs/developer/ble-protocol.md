...
Documented from iOS PacketLogger captures (April 2026) and validated against
...
is the closest known public protocol analysis of the Geberit BLE protocol. The
