...
async def _handle_button(request, service: MeraService):
    ...
    # No pairable toggle here — pairable is now set once at startup in main(), not per
    # button-press (v1.78.0b1). See main()'s comment for why.
...
async def main(web_port: int = 8765) -> None:
    ...
    # Re-enabled 2026-07-19 (v1.78.0b1) — RE-TEST BEFORE RELYING ON THIS.
