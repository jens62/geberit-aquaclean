...
PROCS = {
    ...
    (0x01, 0x0A): "GetActiveCommonSetting",
    (0x01, 0x0B): "SetActiveCommonSetting  [applies immediately, no power cycle]",
    ...
    (0x01, 0x55): "GetDeviceRegistrationLevel (0=NotReg, 1=Private, 2=Public)",
